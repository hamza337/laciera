...
const MetricCard = ({ title, value, sub, sparkColor = '#009382', showTrendArrow = false }) => (
  <div className={styles.ldMetricCard}>
    ...
    <div className={styles.ldMetricRow}>
  ...
  return (
    <section className={styles.ldContent}>
      <div className={styles.ldHeaderRow}>
        <div>
          <h2 className={styles.ldPageTitle}>Dashboard</h2>
      ...
      {/* Row 1: Energy Flow (left) + Energy Consumption (right) */}
      ...
      {/* Row 2: Device Status (left) + AI Recommendations (right) */}
      <div className={styles.ldTwoCols}>
        <div className={styles.ldPanel}>
      ...
      {/* Removed standalone AI panel as it is now stacked in the right column */}
    </section>
  );
};
